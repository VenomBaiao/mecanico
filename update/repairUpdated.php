<?php
	...
	if (isset($_POST['submit'])) {
		...
		$dbcnx = mysqli_connect("127.0.0.1", "root", "root", "compsys_db");
		...
		$sql = "UPDATE repairs SET description = '$description',  car_type = '$device', brand = '$brand', model = '$model', status = '$status' WHERE rep_id = $id";
