...
<head>
    <title>Mecanico - Inventário</title>
        ...
        <div id="top-bar-inner">
            ...
            <div class="search_form">
                <form action="customer-search.php" method="post">
                    <input type="text" name="search_box" id="search_box" placeholder="Buscar por cliente...">
                </form>
            </div>
            <!-- Barra de Pesquisa por http://www.paulund.co.uk/create-a-slide-out-search-box -->
...
<div class="main clearfix">
    ...
    <div class="bread">
        <div class="submenu">
            <ul>
                <li value="Atualizar Inventário" onclick="showUpdate()">Atualizar Inventário</li>
                <li id="add"><a href="addInventory.php">Adicionar Novo Item</a></li>
                <li id="del" value="Excluir Item do Inventário" onclick="showDelete()">Excluir Item do Inventário</li>
            </ul>
        </div>
        <h3>Inventário</h3>
    </div>
    ...
    <div class="floats">
        <div class=" full-widget">
            <div ng-controller="inventoryCrtl">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>Filtrado {{ filtered.length }} de {{ totalItems}} total de itens no inventário</p>
                    </div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-md-12" ng-show="filteredItems > 0">
                        <table class="table table-striped table-bordered">
                            ...
                            <th>Quantidade&nbsp;<a ng-click="sort_by('quantity');"><i class="glyphicon glyphicon-sort"></i></a></th>
                            <th>Preço&nbsp;<a ng-click="sort_by('price');"><i class="glyphicon glyphicon-sort"></i></a></th>
                            </thead>
                            <tbody>
            ...
            <!-- FIM DA LISTA DE ITENS NO INVENTÁRIO -->
        </div>
        ...
        <div class="full-widget" id="updateDiv" style="display:none;">
            ...
            <form class="form-4" method="post" action="updateInventory.php">
                <p>Digite o número de ID:</p> <br>
                <input type="number" name="record" placeholder="Digite o número do item, por exemplo, 1" min="1" maxlength="10" required>
        ...
        <div class="full-widget" id="deleteDiv" style="display:none;">
            <form class="form-4" method="post" action="inventory.php">
                <p>Digite o ID do estoque que deseja excluir: </p> <br>
                <input type="number" name="stock_id" placeholder="Digite o número do item, por exemplo, 1" min="1" maxlength="10" required>
                <input type="submit" name="delete" value="Clique para Excluir" >
            </form>
