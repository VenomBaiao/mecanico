...
<div class="main clearfix">
    ...
    <div class="bread">
        <div class="submenu">
            <ul>
                <li id="products" value="Escolher Produtos" onclick="hideList()">Atualizar Orçamento</li>
                <li id="add"><a href="chooseProducts.php">Escolher Produtos</a></li>
            </ul>
        </div>
        <h3>Orçamentos</h3>
    </div>
        ...
        <div class=" full-widget">
            ...
            <div ng-controller="inventoryCrtl">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>Filtrados {{ filtered.length }} de {{ totalItems}} orçamentos totais</p>
                    </div>
                </div>
                <br/>
                <div class="row">
