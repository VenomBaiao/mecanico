...
<div class="main clearfix">
    ...
    <div class="bread">
        <div class="submenu">
            <ul>
                <li><a href="chooseProducts.php">Voltar</a></li>
                <li id="add"><a href="chooseRepair.php">Fazer Pedido Agora</a></li>
            </ul>
        </div>
        ...
        <div class=" full-widget">
            ...
            <div ng-controller="repairsCrtl">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <br><br><p>Filtrado {{ filtered.length }} de {{ totalItems}} total de reparos</p>
                    </div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-md-12" ng-show="filteredItems > 0">
                        <table class="table table-striped table-bordered">
                            ...
                            <th>Data Adicionada&nbsp;<a ng-click="sort_by('repairdate');"><i class="glyphicon glyphicon-sort"></i></a></th>
